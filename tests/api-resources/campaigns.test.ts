...
describe('resource campaigns', () => {
  ...
  test.skip('create: only required params', async () => {
    ...
    message_samples: ['You are now opted in to receive repair notifications from DT Precision Auto. Frequency varies. Msg&data rates apply. Reply STOP to opt out.', 'You\'re lucky that hundred shot of NOS didn\'t blow the welds on the intake!', 'Your car is ready to go. See your invoice here: https://l.fastauto.shop/s034ij'],
  ...
  test.skip('update: only required params', async () => {
    const responsePromise = client.campaigns.update('cpn_01k0qczvhbet4azgn5xm2ccfst', {
    consent_flow: 'When customers bring in their car for service, they will fill out this web form for intake: https://fastauto.shop/bp108c In it they can choose to opt in to text message notifications. If they choose to opt in, we will send them notifications to let them know if our mechanics find issues and once the car is ready to go, as well as links to invoices and to leave us feedback.',
    description: 'This phone number will send auto maintenance notifications to end users that have opted in. It will also be used for responding to customer inquiries and sending some marketing offers.',
    message_samples: ['You are now opted in to receive repair notifications from DT Precision Auto. Frequency varies. Msg&data rates apply. Reply STOP to opt out.', 'You\'re lucky that hundred shot of NOS didn\'t blow the welds on the intake!', 'Your car is ready to go. See your invoice here: https://l.fastauto.shop/s034ij'],
    privacy_policy_url: 'https://fastauto.shop/sms-privacy',
  ...
  test.skip('update: required and optional params', async () => {
    const response = await client.campaigns.update('cpn_01k0qczvhbet4azgn5xm2ccfst', {
    consent_flow: 'When customers bring in their car for service, they will fill out this web form for intake: https://fastauto.shop/bp108c In it they can choose to opt in to text message notifications. If they choose to opt in, we will send them notifications to let them know if our mechanics find issues and once the car is ready to go, as well as links to invoices and to leave us feedback.',
    description: 'This phone number will send auto maintenance notifications to end users that have opted in. It will also be used for responding to customer inquiries and sending some marketing offers.',
    message_samples: ['You are now opted in to receive repair notifications from DT Precision Auto. Frequency varies. Msg&data rates apply. Reply STOP to opt out.', 'You\'re lucky that hundred shot of NOS didn\'t blow the welds on the intake!', 'Your car is ready to go. See your invoice here: https://l.fastauto.shop/s034ij'],
    privacy_policy_url: 'https://fastauto.shop/sms-privacy',
  ...
  test.skip('list', async () => {
    const responsePromise = client.campaigns.list('acct_01j9a43avnfqzbjfch6pygv1td');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('list: request options and params are passed correctly', async () => {
    ...
    await expect(client.campaigns.list('acct_01j9a43avnfqzbjfch6pygv1td', { after: 'after', before: 'before' }, { path: '/_stainless_unknown_path' }))
      .rejects
