...
describe('resource audiences', () => {
  ...
  test.skip('create: only required params', async () => {
    const responsePromise = client.audiences.create('acct_01j9a43avnfqzbjfch6pygv1td', { name: 'The Family' });
  ...
  test.skip('addContact: only required params', async () => {
    const responsePromise = client.audiences.addContact('aud_01j9a43avnfqzbjfch6pygv1td', { id: 'ctc_01j9dy8mdzfn3r0e8x1tbdrdrf' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('addContact: required and optional params', async () => {
    const response = await client.audiences.addContact('aud_01j9a43avnfqzbjfch6pygv1td', { id: 'ctc_01j9dy8mdzfn3r0e8x1tbdrdrf' });
  });
  ...
  test.skip('listContacts: request options and params are passed correctly', async () => {
    ...
    await expect(client.audiences.listContacts('aud_01j9a43avnfqzbjfch6pygv1td', { after: 'after', before: 'before' }, { path: '/_stainless_unknown_path' }))
      .rejects
