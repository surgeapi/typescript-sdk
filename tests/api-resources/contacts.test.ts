...
describe('resource contacts', () => {
  ...
  test.skip('create: only required params', async () => {
    const responsePromise = client.contacts.create('acct_01j9a43avnfqzbjfch6pygv1td', { phone_number: '+18015551234' });
  ...
  test.skip('update: only required params', async () => {
    const responsePromise = client.contacts.update('ctc_01j9dy8mdzfn3r0e8x1tbdrdrf', { phone_number: '+18015551234' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('list: request options and params are passed correctly', async () => {
    ...
    await expect(client.contacts.list('acct_01j9a43avnfqzbjfch6pygv1td', { after: 'after', before: 'before' }, { path: '/_stainless_unknown_path' }))
      .rejects
