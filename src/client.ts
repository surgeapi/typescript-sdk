...
export interface ClientOptions {
   ...
   * Set the log level.
   *
   * Defaults to process.env['SURGE_LOG'] or 'warn' if it isn't set.
   */
...
export class Surge {
  ...
  constructor({
    ...
    this.timeout = options.timeout ?? Surge.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    const customHeadersEnv = readEnv('SURGE_CUSTOM_HEADERS');
    if (customHeadersEnv) {
  ...
  #baseURLOverridden(): boolean {
    return this.baseURL !== 'https://api.surge.app';
  }
